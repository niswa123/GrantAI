      ...
      <div className="hidden lg:flex relative overflow-hidden bg-slate-950 items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white mb-6 leading-tight">
            Turn your R&D into <br/> <span className="text-brand-primary">growth capital.</span>
          </h2>
          <p className="text-lg text-slate-400 leading-relaxed mb-10">
            Identify eligible activities, track expenses automatically, and generate compliant tax credit claims with minimal effort.
          </p>
          
          <div className="flex items-center gap-4 text-sm text-slate-300">
            <div className="flex -space-x-3">
              <div className="w-10 h-10 rounded-full border border-slate-700 bg-slate-800 flex items-center justify-center text-white z-30">
                <img src="https://api.dicebear.com/9.x/shapes/svg?seed=user1&backgroundColor=06b6d4" className="w-full h-full rounded-full" alt="User" />
              </div>
              <div className="w-10 h-10 rounded-full border border-slate-700 bg-slate-800 flex items-center justify-center text-white z-20">
                <img src="https://api.dicebear.com/9.x/shapes/svg?seed=user2&backgroundColor=f8fafc" className="w-full h-full rounded-full" alt="User" />
              </div>
              <div className="w-10 h-10 rounded-full border border-slate-700 bg-slate-800 flex items-center justify-center text-xs font-medium text-white z-10">+</div>
            </div>
