...
export function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[110vh] w-full bg-slate-950 overflow-hidden">
      <motion.div 
        style={{ scale, opacity }}
      ...
      >
        ...
        <motion.h1
          ...
          className="text-5xl md:text-8xl font-black tracking-tighter mb-8 text-white leading-[1.05] max-w-5xl mx-auto"
        >
          Turn Code into <br />
        ...
        <motion.p
          ...
          className="text-lg md:text-2xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed font-medium"
        >
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button size="xl" className="group px-10 py-8 text-lg rounded-full overflow-hidden bg-white hover:bg-slate-100 text-black border border-white shadow-[0_0_30px_rgba(255,255,255,0.2)]">
              Start Tracking Daily Value
              <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1.5 transition-transform" />
            </Button>
          </motion.div>
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button variant="premium" size="xl" className="px-10 py-8 text-lg rounded-full border border-white/10 bg-slate-900/50 hover:bg-slate-800">
              See How it Works
            </Button>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className="relative rounded-t-3xl md:rounded-t-[40px] border-t border-x border-white/15 bg-slate-950/80 backdrop-blur-2xl p-6 md:p-10 overflow-hidden shadow-2xl h-[450px] flex flex-col transition-transform duration-700 ease-out group-hover:-translate-y-2">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-white/5 pb-6 mb-6 gap-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-2xl bg-cyan-500/10 flex items-center justify-center border border-cyan-500/20 shadow-[0_0_15px_rgba(6,182,212,0.1)]">
                  <Cpu className="w-7 h-7 text-cyan-400" />
                </div>
                <div className="text-left">
                  <div className="text-white font-bold text-xl tracking-tight">AI Engine v2.0</div>
                  <div className="text-cyan-400 text-sm font-medium flex items-center gap-2 mt-1">
                    <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" /> Scanning Jira & GitHub...
                  </div>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="px-5 py-2.5 rounded-full border border-white/5 bg-white/5 text-sm font-medium text-slate-300">Confidence: <span className="text-white font-bold">99.8%</span></div>
              </div>
            </div>

            {/* Dashboard Mock Body - Code & Report side by side */}
            <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-8 relative">
              {/* Left: Code Box */}
              <div className="rounded-3xl bg-black/50 border border-white/5 p-6 font-mono text-sm text-slate-400 overflow-hidden relative shadow-inner">
                <div className="absolute top-4 right-4 text-xs font-bold uppercase tracking-widest text-slate-600">Terminal</div>
                <motion.div 
                  initial={{ y: 0 }} 
                  animate={{ y: -60 }} 
              ...
              <div className="rounded-3xl bg-gradient-to-br from-cyan-950/30 to-slate-900/50 border border-cyan-500/20 p-6 relative">
                ...
                <div className="text-white font-bold text-lg mb-6">Real-time Value Dashboard</div>
