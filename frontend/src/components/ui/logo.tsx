...
export function Logo({ className = "w-8 h-8", showText, textSize }: LogoProps) {
  return (
    <div className={`relative flex items-center justify-center shrink-0 group select-none ${className}`}>
      {/* Subtle hover glow */}
