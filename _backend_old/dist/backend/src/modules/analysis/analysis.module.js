...
exports.AnalysisModule = AnalysisModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [analysis_service_1.AnalysisService, rd_classifier_service_1.RdClassifierService, llm_client_service_1.LlmClientService],
        exports: [analysis_service_1.AnalysisService, rd_classifier_service_1.RdClassifierService, llm_client_service_1.LlmClientService],
    })
], AnalysisModule);
